...
class PrideQuizApp:
    def __init__(self, root):
        ...
        self.quotes = self.load_quotes('pride_quotes.csv')
        self.current_quote = None
        self.start_time = None

        self.name_label = tk.Label(root, text="Please enter your name:")
        self.name_label.pack(pady=20)

        self.name_entry = tk.Entry(root)
        self.name_entry.pack(pady=10)

        self.submit_button = tk.Button(root, text="Start Quiz", command=self.start_quiz)
    ...
    def check_answer(self, answer):
        ...
        # ✅ Only update the existing label
    ...
    def save_score(self):
        ...
        if existing_entry:
            ...
            leaderboard.append({"name": self.user_name, "score": self.score})
